...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el país del atleta buscado
	 * 
	 * @param nombreAtleta El nombre del atleta que se está buscando
	 * @return El país con el nombre dado o null si no se encuentra.
	 */
	public String obtenerPaisdeAtleta (String nombreAtleta)
	{
		Atleta atletaBuscado = buscarAtleta(nombreAtleta);
		String paisBuscado;
		if (atletaBuscado ==(null))
		{
			paisBuscado = "No se encontró el atleta";
		}
		else
		{
			paisBuscado = atletaBuscado.darPais().darNombre();
		}
		return paisBuscado;
