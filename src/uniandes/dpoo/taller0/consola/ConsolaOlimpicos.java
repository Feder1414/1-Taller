...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le pide al usuario el nombre de un atleta para posteriormente mostrarle su país
	 */
	private void ejecutarPaisAtleta()
	{
		String nombreAtleta = input("Por favor ingres el nombre del atleta");
		String paisAtleta = calculadora.obtenerPaisdeAtleta(nombreAtleta);
		if (paisAtleta.equals("No se encontró el atleta"))
		{
			System.out.println(paisAtleta);
		} 
		else
		{
